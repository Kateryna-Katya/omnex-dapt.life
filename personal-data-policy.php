        ...
        <div class="container">
            ...
            <div class="legal-content glass-block" data-aos="fade-up">
                ...
                <div class="legal-section">
                    <h2><i data-lucide="shield-check"></i> 1. Общие положения</h2>
                    <p>
                        Настоящая политика обработки персональных данных определяет порядок и условия обработки информации, 
                        предпринимаемые платформой <strong><?= $domainTitle ?></strong> (далее — «Оператор»), 
                        в соответствии с требованиями безопасности данных, принятыми в странах ЕС.
                    </p>
                    <p>
                        1.1. Важнейшей целью Оператора является соблюдение прав и свобод человека при обработке его данных, 
                        включая защиту права на неприкосновенность частной жизни и личную тайну.
                    </p>
                    <p>
                        1.2. Политика применяется ко всей информации, которую Оператор может получить о посетителях 
                        веб-сайта <strong><?= $fullDomain ?></strong>.
                    </p>
                </div>

                <div class="legal-section">
                    <h2><i data-lucide="book-open"></i> 2. Основные понятия</h2>
                    <ul class="terminology-list-grid">
                        <li><strong>Веб-сайт</strong> — ресурс <strong><?= $fullDomain ?></strong>.</li>
                        <li><strong>Пользователь</strong> — любой посетитель платформы.</li>
                        <li><strong>Персональные данные</strong> — информация, прямо относящаяся к Пользователю.</li>
                        <li><strong>Обработка</strong> — сбор, систематизация и хранение данных.</li>
                    </ul>
                </div>

                <div class="legal-section">
                    <h2><i data-lucide="database"></i> 3. Данные, которые мы обрабатываем</h2>
                    <div class="data-grid-policy">
                        <div class="data-item-box">
                            <i data-lucide="user"></i>
                            <div class="data-item-box__info">
                                <strong>Личные данные:</strong>
                                <p>ФИО, Email, номер телефона для связи.</p>
                            </div>
                        </div>
                        <div class="data-item-box">
                            ...
                            <div class="data-item-box__info">
                                ...
                                <p>Cookies, анонимные данные о браузере и IP-адрес.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="legal-section">
                    <h2><i data-lucide="briefcase"></i> 4. Цели обработки данных</h2>
                    <ul class="legal-list">
                        <li>Идентификация Пользователя для консультаций по росту.</li>
                        <li>Установление обратной связи и обработка заявок.</li>
                        <li>Персонализация стратегий в рамках Карьерного апгрейда.</li>
                        <li>Улучшение качества работы блога и инновационных инструментов.</li>
                    </ul>
                </div>

                <div class="legal-section">
                    <h2><i data-lucide="gavel"></i> 5. Правовые основания</h2>
                    <p>
                        Оператор обрабатывает данные только при наличии вашего добровольного согласия, выраженного через 
                        использование форм на сайте или настройки файлов «cookie» в вашем браузере.
                    </p>
                </div>

                <div class="contact-info-block agreement-cta">
                    <h2><i data-lucide="help-circle"></i> 6. Вопросы и отзывы</h2>
                    <p>Если у вас возникли вопросы по поводу защиты данных на <strong><?= $domainTitle ?></strong>, свяжитесь с нами:</p>
                    <div class="policy-contacts">
                        <a href="mailto:support@<?= $fullDomain ?>" class="policy-link-item">
                            <i data-lucide="mail"></i> support@<?= $fullDomain ?>
                        </a>
                        <a href="tel:+49305525094" class="policy-link-item">
                            <i data-lucide="phone"></i> +49 30 5525 094
                        </a>
                    </div>
                </div>
