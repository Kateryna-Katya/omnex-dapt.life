        ...
        <div class="container">
            ...
            <div class="contact-cards">
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <p class="contact-card__desc">Для общих вопросов, предложений и запросов на консалтинг:</p>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <p class="contact-card__desc">Прямая линия поддержки клиентов и экспертных консультаций:</p>
                    <a href="tel:+49305525094" class="contact-link">+49 30 5525 094</a>
                </div>
                ...
                <div class="contact-card" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <p class="contact-card__desc">Главный офис компании <strong><?= $domainTitle ?></strong> расположен по адресу:</p>
            ...
            <div class="contact-extra" data-aos="fade-up">
                <p>
                    ...
                    <a href="./#contact" class="text-gradient">главной странице</a> для быстрой отправки запроса.
                </p>
            </div>
        </div>
    </section>
